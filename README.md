...
2. Prepare your solution using 'make make-prepare';  
   2.1. **Note!** If you previously type projects names in Makefile:Projects variable and then execute 'make make-prepare', Make will create all marked projects
...
* Run 'make' in the solution directory. Make will build each your project with dependencies. To build only one project use 'make MyNewProject' or directly run project makefile 'make -f MyNewProject.mk'
